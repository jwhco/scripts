...
Manage large podcast channels with less effort and greater efficiency. This works for any kind of eposodic content.
...
- **Fast track eposide promotions**. Turn transcripts, descriptions, media metadata, into context for promotion. Draft social media posts, show notes,
...
- **Setup a content library**, a markdown text directory often behind a note-taking application like Obsidian or Zettlr. This folder is a git repository. It contains draft and finished markdown episode sidecars. Best if next to the scripts folder.
...
- **Content Marketer** find and transform podcasts into Reports, Courses, and service delierables. Mine past episodes to extract key points, concepts, and ideas to better serve the underlying audience. 
  ...
  - Optimizing podcast episode descriptions across media channels (YouTube, Bitchute, Rumble) even if unique conversation on each. A podcast episode can branch as it moves across channels while keeping descriptives unique in content library.
