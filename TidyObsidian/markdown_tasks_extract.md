...
- With the `--fix-id true` be able to add ID to any task that doesn't already have one. Plus, that ID will be an Obsidian Tasks plugin Dataview compatible format.
